...
class LinearImpactRenderer(IsolineRenderer):
    """Отрисовка изолиний для линейного объекта."""
...
def draw_linear_impact_zones(main_window) -> bool:
    """Отрисовывает изолинии для выбранного линейного объекта."""
